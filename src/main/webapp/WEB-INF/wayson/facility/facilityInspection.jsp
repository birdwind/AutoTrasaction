...
$("#facilityInspection").kendoGrid(
      {
        dataSource: 
        {
            data: [
              {
                id:1,
                facilityInspection_no: "eve-29101105-3", 
                classification: [{text:"唯聖",value:1},{text:"新光",value:2},{text:"台南",value:3}], 
                facilityInspection_Data: "2019/11/07" ,
                company: [{text:"唯聖",value:1},{text:"新光",value:2},{text:"台南",value:3}] ,
                warehouse:[{text:"1號倉",value:1},{text:"2號倉",value:2},{text:"3號倉",value:3}] ,
              }
            ],
              schema: {
              model: { 
                id:"id",
                classification: [{text:"001",value:1},{text:"002",value:2},{text:"003",value:3}], 
                company: [{text:"唯聖",value:1},{text:"新光",value:2},{text:"台南",value:3}],
                warehouse:[{text:"1號倉",value:1},{text:"2號倉",value:2},{text:"3號倉",value:3}] ,
              }
            }
        ...
        columns: [
          ...
          {
            field: "facilityInspection_no",
            title: "驗布機編號"
          }, 
          {
            field: "facilityInspection_name",
            title: "隸屬公司" ,
          ...
          {
             field: "facilityInspection_Data",
            title: "購入日期"
            
          },
           {
            field: "facilityInspection_company",
            title: "購入廠商",
           ...
           {
            field: "facilityInspection_warehouse",
            title: "附屬驗布倉" ,
            template: "#=generateTemplate(warehouse,selectedValue1)#", 
            editor: function(container, options) {
               if (options.model.warehouse.length <= 1)
                            return;
              var input = $('<input id="warehouse" name="warehouse" data-text-field="text" data-value-field="value" data-bind="value:' + options.field + '">');
               input.appendTo(container);
                input.kendoDropDownList({
                    dataSource: options.model.warehouse,
                    dataTextField: "text",
                    dataValueField: "value",
                     change: function(e) {
                      selectedValue1 = e.sender.value();
    ...
    $("body").on("click", ".specification", function(){
        ...
        var rowTd=$(this).closest("td");
         $("#facilityInspection").data("kendoGrid").editRow(row);
    ...
    $('body').on('click', '#addbtn', function () {
      ...
      $("#facilityInspection").data("kendoGrid").addRow();
       var row = $("#facilityInspection").find(".k-grid-edit-row");
        row.find("input").css("width","90%");
    ...
    $('body').on('click', '#facilityInspection .k-checkbox', function () {
    $("#trashBin").hide();
    if($("#facilityInspection .k-grid-content tbody input:checkbox:checked").length){
      $("#trashBin").show();
    }
          ...
          <div class="box-body no-padding">
            <section class="content-header">
              <ol id="breadcrumb" class="breadcrumb">
                ...
                <li class="active"><a href="/page/shipment/facilityInspection/"></a></li>
              </ol>
            </section>
            <div id="facilityInspection">
            </div> 
