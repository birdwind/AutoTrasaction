...
$("#facilityWefting").kendoGrid(
      {
        dataSource: 
        {
            data: [
              {
                id:1,
                facilityWefting_no: "eve-29101105-3", 
                classification: [{text:"唯聖",value:1},{text:"新光",value:2},{text:"台南",value:3}], 
                facilityWefting_Data: "2019/11/07" ,
        ...
        columns: [
          ...
          {
            field: "facilityWefting_no",
            title: "穿綜機編號"
          }, 
          {
            field: "facilityWefting_name",
            title: "隸屬公司" ,
          ...
          {
             field: "facilityWefting_Data",
            title: "購入日期"
            
          },
           {
            field: "facilityWefting_company",
            title: "購入廠商",
    ...
    $("body").on("click", ".specification", function(){
        ...
        var rowTd=$(this).closest("td");
         $("#facilityWefting").data("kendoGrid").editRow(row);
    ...
    $('body').on('click', '#addbtn', function () {
      ...
      $("#facilityWefting").data("kendoGrid").addRow();
       var row = $("#facilityWefting").find(".k-grid-edit-row");
        row.find("input").css("width","90%");
    ...
    $('body').on('click', '#facilityWefting .k-checkbox', function () {
    $("#trashBin").hide();
    if($("#facilityWefting .k-grid-content tbody input:checkbox:checked").length){
      $("#trashBin").show();
    }
          ...
          <div class="box-body no-padding">
            <section class="content-header">
              <ol id="breadcrumb" class="breadcrumb">
                ...
                <li class="active"><a href="/page/shipment/facilityWefting/"></a></li>
              </ol>
            </section>
            <div id="facilityWefting">
            </div> 
