...
$("#beamExport").kendoGrid(
      {
        dataSource: [ { beam_import_no: "ce-20190811-2",order:"od-20190811-2",order1:"mo-20190811-2",amount:"2020/10/2 / 3000Y",kind:"ws-1234",number:"ws-1234/甲1-1/丙2-3",
        long:"3000Y",warehouse_stock_detail_id:"唯聖出貨倉B區", actual_import_datetime: "2019/10/9 23:12" ,importer:"王宇臣",workstation:"im-001"},],
        ...
        columns: [{
            ...
            title: "出庫編號", // set its title to "Name"
            template:function (d) {
              return "<a class='number_a' href='/page/shipment/clothExport/form/0001'>"+d.beam_import_no+"</a>"
            }
          },{
            field: "order1",// create a column bound to the "name" field
            title: "訂單編號" // set its title to "Name"
          },{
            field: "amount",// create a column bound to the "name" field
            title: "訂單交期/數量" // set its title to "Name"
          },{
...
<body class="hold-transition skin-green-light sidebar-mini">
          ...
          <div class="box-body no-padding">
            <section class="content-header">
              <ol id="breadcrumb" class="breadcrumb">
                ...
                <li class="active"><a href="/page/shipment/clothExport"></a></li>
              </ol>
            </section>
            <div id="beamExport">
            </div> 
  ...
  <div id="toolbar" style="display:none;">
      <div class="col-sm-4 col-xs-6 table_bar_box">
        <a href="/page/shipment/clothExport/form" class="btn"><i class="fa fa-plus"></i></a>
