...
$(async function () {
  ...
  $("input[name='warpYarnBatchNo']").kendoDropDownList({
      dataSource: [{text:"熙語文",value:1},{text:"熙宇文",value:2},{text:"熙羽文",value:3}],
      dataTextField: "text",
      dataValueField: "value",
      optionLabel: " ",
  })
  $("input[name='beamAmount']").kendoDropDownList({
      dataSource: [{text:"ci-20191009-1",value:1},{text:"ci-20191009-2",value:2},{text:"ci-20191009-3",value:3}],
      dataTextField: "text",
      dataValueField: "value",
      optionLabel: " ",
  })
                    ...
                    <div id="form" class="box-body">
                     <div class="col-md-12 box_inputdata">
                        ...
                        <fieldset >
                          <div class="form-group">
                           <nav >來源驗布機</nav>
                           <input class="form-control" type='text' name="nowStation" value="">
                          </div>
                        </fieldset>
                        <fieldset >
                          <div class="form-group">
                    ...
                    <div id="form2" class="box-body" style="display:none">
                      <div class="col-md-12 box_inputdata">
                        ...
                        <fieldset class="disabled">
                          <div class="form-group">
                           <nav>長度</nav>
                          <span class="form-control labelText">500Y</span>
                           <input type='hidden' name="nowStation1" value="">
                          </div>
                        </fieldset>
                        <fieldset class="disabled">
                          <div class="form-group">
                           <nav>入庫倉庫</nav>
                           <span class="form-control labelText">唯聖出貨倉A區</span>
                        ...
                        <fieldset class="disabled">
                          <div class="form-group">
                           <nav>入庫時間</nav>
                           <span class="form-control labelText">2019/10/8 23:12</span>
                        ...
                        <fieldset class="disabled">
                          <div class="form-group">
                           <nav>入庫人員</nav>
                           <span class="form-control labelText">熙語文</span>
                           <input type='hidden' name="nowStation2" value="">
                          </div>
                        </fieldset>
                        <fieldset class="disabled">
                          <div class="form-group">
                           <nav>來源驗布機</nav>
                           <span class="form-control labelText">m-001</span>
                        ...
                        <fieldset  class="disabled">
                          <div class="form-group">
                           <nav style="vertical-align: top;">備註</nav>
                           <textarea name="note" class="form-control textareaSize" readonly="readonly">123456789</textarea>
                          </div>
                        </fieldset>
                      </div>
                    </div><!--#form2-->
