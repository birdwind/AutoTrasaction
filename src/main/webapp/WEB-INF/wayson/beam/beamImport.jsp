...
<head>
  ...
  <script src="${webapps.contextPath}/scripts/beam/beamImportGrid.js"></script>
</head>
...
<body class="hold-transition skin-green-light sidebar-mini">
          ...
          <div class="box-body no-padding">
            <section class="content-header">
              <ol id="breadcrumb" class="breadcrumb">
                ...
                <li class="active"><a href="/page/beam/beamImport"></a></li>
              </ol>
            </section>
            <div id="beamImport">
            </div>
  ...
  <div id="toolbar" style="display:none;">
    <div class="col-sm-4 col-xs-6 table_bar_box">
      <a href="/page/beam/beamImport/form" class="btn"><i class="fa fa-plus"></i></a>
