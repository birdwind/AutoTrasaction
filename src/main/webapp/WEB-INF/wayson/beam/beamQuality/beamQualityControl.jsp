...
<head>
  ...
  <script src="${webapps.contextPath}/scripts/beam/beamQuality/beamQualityControl.js"></script>
...
<div id="toolbar" style="display:none;">
  <div class="col-sm-4 col-xs-6 table_bar_box">
    <a href="/page/beam/quality/control/form" class="btn"><i class="fa fa-plus"></i></a>
