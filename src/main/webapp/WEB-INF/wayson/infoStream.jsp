...
<script src="${webapps.contextPath}/scripts/yarnInquiryGuest.js"></script>
<script>
                ...
                <div class="col-md-12">
                  <div class="box box-success" style="padding-bottom:20px">
                    ...
                    <table id="inquiry" class="table bg_white table-striped table-bordered table-hover">
                      ...
                      <tr>
                        <th><span class="yarnUuidTitle"></th>
                        <th style="width:20%"><span class="amountTitle"></span></th>
                        <th style="width:15%"><span class="warpWeftTitle"></span></th>
                        <th style="width:15%"><span class="priceTitle"></span><span class="color_pink">*</span></th> 
                      </tr>
                      </thead>
                      <tbody>
                      </tbody>
...
<tr>
  <td>
    <span name="yarnUuid"></span>
    <input type="hidden" name="yarnInquiryItemUuid">
  </td>
  <td>
