...
var columnTemplate= {
        "No": function (d) {
          return "<a class='number_a' href='/page/site/weaving/form/" + d.uuid+ "'>" + d.No + "</a>";
        }
}
var dataSource = new kendo.data.DataSource({
  transport: {
    read: {
      url: '/scripts/json/siteWeaving.json',
      dataType: "json",
      type: "GET",
      processData: false,
      contentType: false
                ...
                <div class="col-md-12">
                  <ol class="monitormenu">
                    <li data-section="inventTotal" class="active">
                      <a href="javascript:void(0)">上軸</a>
                    </li>
                    <li data-section="inventory">
                      <a href="javascript:void(0)">落布</a>
                    </li>
                     <li data-section="inventory">
                      <a href="javascript:void(0)">改緯</a>
                    </li>
                     <li data-section="inventory">
                      <a href="javascript:void(0)">各種班量</a>
                    </li>
                     <li data-section="inventory">
                      <a href="javascript:void(0)">換軸<a>
                    </li>
                  </ol>
                </div><!-- col-->
                </div><!-- row-->
