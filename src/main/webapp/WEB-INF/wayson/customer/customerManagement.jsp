...
<head>
  ...
  <script src="${webapps.contextPath}/scripts/customer/customerGrid.js"></script>
...
<div id="toolbar" style="display:none;">
  <div class="col-sm-4 col-xs-6 table_bar_box">
    <a href="/page/customer/management/form" id="addRow" class="btn addbtn"><i class="fa fa-plus"></i></a>
