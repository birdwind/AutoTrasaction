...
<script src="${webapps.contextPath}/scripts/yarn/yarnInquiryUpdate.js"></script>
<script>
...
<div id="caseClosed" class="scrollbar">
<section class="content">
  <div class="row">
    <div class="col-md-12"> 
      <div class="box-body">
        ...
        －結案後將無法再次針對此張詢價單與廠商溝通－
        </span></center><br/>
        <div class="col-md-12 box_inputdata">
          <fieldset>
            <div class="form-group">
              <nav>結案狀態<span class="color_pink">*</span></nav>
              <input type="text" name="yarnInquiryCoreClosedStatusUuid" class="form-control">
        ...
        <div class="col-md-12 box_inputdata">
          <fieldset>
            <div class="form-group">
              <nav>是否通知詢價人牌價<span class="color_pink">*</span></nav>
              <input type="text" name="notifyInquirer" class="form-control number">
              <span class="errorMsg color_pink"></span>
            </div>
          </fieldset>
        </div><!--box_inputdata-->
        <span id="priceFeedBack">
        </span>
        <div class="col-md-12 box_inputdata">
          <fieldset>
            <div class="form-group">
              <nav style="vertical-align:top">備註</nav>
              <textarea name="note" class="form-control textareaSize" rows="4"></textarea>
              <span class="errorMsg color_pink"></span>
            </div>
          </fieldset>
        </div><!--box_inputdata-->
        <div class="col-md-12 box_inputdata">
          <fieldset>
            <div class="form-group">
              <nav style="vertical-align:top">詢價滿意度<span class="color_pink">*</span></nav>
              <ul class="satisfy" >
                <li>
                  <label>
                    <input type="radio" name="inquirySatisfaction" class="number" value="0">
                    <div class="emojiCheck"></div>
                    <div class="emoji"></div>
                  </label>
                </li>
                <li>
                  <label>
                  <input type="radio" name="inquirySatisfaction" class="number"  value="1">
                  <div class="emojiCheck"></div>
                  <div class="emoji"></div>
                  </label>
                </li>
                <li>
                  <label>
                  <input type="radio" name="inquirySatisfaction" class="number"  value="2">
                  <div class="emojiCheck"></div>
                  <div class="emoji"></div>
                  </label>
                </li>
              ...
              <span class="errorMsg color_pink"></span>
              <button id="save" type="button" class="btn btn-success circleBtn white" style='float:right'>儲存</button>
            </div>
