...
<script src="${webapps.contextPath}/scripts/yarn/yarnPurchaseGuest.js"></script>
<script>
                ...
                <div class="col-md-12">
                  <div class="box box-success" style="padding-bottom:40px">
                    <div class="table_bar">
                        ...
                        <button id="savePrice" type="button" class="btn btn-success white" style='float:right'>儲存</button>
                    </div>
                    <table id="purchase" class="table bg_white table-striped table-bordered table-hover" style="margin-bottom:5px">
                          ...
                          <tr>
                              ...
                              <th style="width:10%"><span>數量</span></th>
                              <th style="width:9%"></th>
