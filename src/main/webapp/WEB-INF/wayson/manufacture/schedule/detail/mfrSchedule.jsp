...
<head>
  ...
  <script src="${webapps.contextPath}/scripts/manufacture/schedule/detail/mfrSchedule.js"></script>
</head>
...
<body class="hold-transition skin-green-light sidebar-mini">
  ...
  <div id="toolbar" style="display:none;">
    <div class="col-sm-4 col-xs-6 table_bar_box">
      <a href="/page/manufacture/order/form" class="btn"><i class="fa fa-plus"></i></a>
