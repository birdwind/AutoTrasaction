...
<head>
  ...
  <script src="${webapps.contextPath}/scripts/manufacture/outsourcing/beamCreate.js"></script>
</head>
...
<body class="hold-transition skin-green-light sidebar-mini">
                            ...
                            <div class="table-responsive">
                              <div class="table_bar">
                                <div class="col-sm-4 col-xs-6 table_bar_box">
                                  <a href="javascript:void(0)" id="addDetail" class="btn"><i class="fa fa-plus"></i></a>
                                </div>
                              </div>
  ...
  <script type="text/x-kendo-template" id="tableTheadTemplate">
    <tr>
      <th scope="col" width="30%">#=data.clothOrderDetail.title#<span class='color_pink'>*</span></th>
  ...
  <script type="text/x-kendo-template" id="tableTbodyTemplate">
    <tr>
      ...
      <td>
          <input id="amount_#=data#" type="text" class="form-control number integer" name="amount" value="">
          <span class="errorMsg color_pink"></span>
      </td>
      <td>
