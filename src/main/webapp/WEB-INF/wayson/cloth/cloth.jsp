...
<style>
  ...
  <script src="${webapps.contextPath}/scripts/cloth/clothGrid.js"></script>
...
<body class="hold-transition skin-green-light sidebar-mini">
          ...
          <div class="box-body no-padding">
            <section class="content-header">
              <ol id="breadcrumb" class="breadcrumb">
                ...
                <li class="active"><a href="/page/cloth/specification"></a></li>
              </ol>
            </section>
            <section id="cloth">
            </section>
  ...
  <div id="toolbar" style="display:none;">
      <div class="col-sm-4 col-xs-6 table_bar_box">
        <a href="/page/cloth/specification/form" class="btn"><i class="fa fa-plus"></i></a>
