...
<script src="${webapps.contextPath}/scripts/clothOrder/clothForm.js"></script>
<style>
#detail th,
#detail td{
  text-align:center;
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="box_features">
                    ...
                    <button type="button" onclick="location='/page/orderManagement/clothOrder'"class="btn backBtn circleBtn white">
