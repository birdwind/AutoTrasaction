...
<head>
  ...
  <script src="${webapps.contextPath}/scripts/buckleManagement/buckleInventoryGrid.js"></script>
  <script>
    // $(async function () {
    // $("#buckleInventory").kendoGrid(
    //       {
    //         dataSource: [ { buckle_import_no: "buckle-001",warehouse_stock_detail_id:"唯聖盤頭倉",
    ...
    //         },
    //         columns: [{
    //             field: "buckle_import_no",// create a column bound to the "name" field
    //             title: "盤頭編號", // set its title to "Name"
    //             template:function (d) {
    //               return "<a class='number_a' href='/page/buckle/buckleInventory/form'>"+d.buckle_import_no+"</a>"
    //             }
    //           },
    //           {
          ...
          <div class="box-body no-padding">
            <section class="content-header">
              <ol id="breadcrumb" class="breadcrumb">
                ...
                <li class="active"><a href="/page/buckle/buckleInventory"></a></li>
              </ol>
            </section>
            <div id="buckleInventory">
            </div>
