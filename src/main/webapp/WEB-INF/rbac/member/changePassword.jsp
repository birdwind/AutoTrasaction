...
<head>
  ...
  <!-- css -->
  <link rel="stylesheet" href="${webapps.contextPath}/styles/modules/member/changePassword.css"/>
  <!-- end css -->
  ...
  <script type="text/javascript"
          src="${webapps.contextPath}/scripts/modules/member/changePassword.js"></script>
  <script type="text/javascript"
