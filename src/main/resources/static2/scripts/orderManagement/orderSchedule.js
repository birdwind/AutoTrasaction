$(function () {
  ...
  $("#form").formWizard({
    ...
    url: "/scripts/orderManagement/orderSchedule/" + clothOrderDetailDeliverQuantityUuid + ".json",
...
function customizeForm() {
  ...
  var scheduleShipmentDetails = fw_formData.response.scheduleShipmentDetails;
  ...
  setTitleByTableId("scheduleShipmentDetails", scheduleShipmentDetails.header);
  ...
  setContentByTableId("scheduleShipmentDetails", scheduleShipmentDetails.contents);
