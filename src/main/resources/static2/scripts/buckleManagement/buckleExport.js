$(async function () {
  let grid = new Grid("/buckle/buckleExport/", "grid,noToolbar", "buckleExport", "buckleCore");
  ...
  await grid.creatKendGrid("#beamExport", filterable);
        ...
        $("#betweenDate").kendoDateRangePicker({
          ...
          change: function (e) {
            ...
            let startDate = this._range.start,
              ...
              dataSource = $("#beamExport").data("kendoGrid").dataSource;
